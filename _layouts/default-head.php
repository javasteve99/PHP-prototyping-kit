...
<!-- The next line optimizes for mobile viewports, delete it if you don't want to support mobile -->
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Consider placing favicon.ico and apple-touch-icon.png in the root directory instead: mathiasbynens.be/notes/touch-icons -->
